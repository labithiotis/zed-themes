  ...
  return (
    <div className="flex h-screen w-full content-stretch bg-stone-300 dark:bg-stone-900 dark:text-zinc-200">
      <div className="flex w-full flex-col px-6 py-4">
        ...
        <div className="grid w-full gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 pb-6">
          {themes?.map((theme, t1) => (
            <Carousel key={theme.id} className="items flex flex-col gap-2" opts={{ active: theme.themes?.length > 1 }}>
              ...
              <div className="flex flex-col isolate min-h-[20vw] lg:min-h-[14vw]">
